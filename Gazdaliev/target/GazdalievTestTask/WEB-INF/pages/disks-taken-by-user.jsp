...
<h2>Here you can view all the disks, you've borrowed</h2>
<table border="1px" cellpadding="0" cellspacing="0" >
    ...
    <c:forEach var="disk" items="${takenbyuser}">
        <tr>
            <td>${disk.name}</td>
            ...
            <td>
                <a href="${pageContext.request.contextPath}/takendisk/giveback/${disk.id}.html">Give Back</a><br/>
            </td>
        </tr>
    </c:forEach>
    </tbody>
